            ...
            <div className="w-full mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20">
                <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 xl:gap-20">         
                    ...
                    <div className="lg:w-1/2">
                        <div className="w-1/2 h-[360px] relative rounded-xl overflow-hidden shadow-xl">
                            <iframe 
                    ...
                    <div className="w-full lg:w-1/2">
                        <div className="grid grid-cols-3 gap-10">
                            ...
                            <div>
                                ...
                                <div>
                                    <h3 className="text-xl sm:text-2xl font-semibold mb-4">Phone Number</h3>
                                    <p>
                                        <a 
                                ...
                                <div className="space-y-3 text-gray-300 text-lg">
                                    <p className="grid grid-cols-2">
                                        <div>
                                            <span>Monday</span>
                                            <span className="">8 AM - 6 PM</span>
                                        </div>
                                         <div>
                                            <span>Tuesday</span>
                                            <span className="ml-12">8 AM - 6 PM</span>
                                        </div>
                                         <div>
                                            <span>Wednesday</span>
                                            <span className="ml-4">8 AM - 6 PM</span>
                                        </div>
                                         <div>
                                            <span>Thursday</span>
                                            <span className="ml-8">8 AM - 6 PM</span>
                                        </div>
                                         <div>
                                            <span>Friday</span>
                                            <span className="ml-8">8 AM - 6 PM</span>
