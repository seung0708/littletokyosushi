    ...
    return (
        <section id="hero" className="relative bg-gray-950 text-white">
            ...
            <div className="relative mx-auto flex max-w-3xl flex-col items-center px-6 py-32 text-center sm:py-64 lg:px-0">
                ...
                <a href='/menu' className="mt-8 inline-block rounded-md border border-transparent bg-red-500 px-8 py-3 text-base text-md sm:text-lg md:text-xl font-bold hover:bg-red-300">Order Now</a>
            </div>
        </section>
    )
}
