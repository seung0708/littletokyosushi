                        ...
                        <div className='relative flex w-full items-center overflow-hidden bg-white px-4 pb-8 pt-14 shadow-2xl sm:px-6 sm:pt-8 md:p-6 lg:p-8'>
                            ...
                            <div className='grid w-full grid-cols-1 items-start'>
                                ...
                                <div className={`relative w-full aspect-h-2 aspect-w-4 rounded-lg duration-700 ease-in-out ${index === activeIndex ? '' : 'hidden'} border-b`} data-carousel-item>
                                    <img src={image} className='h-full object-contain object-center -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2' /> 
                                     {/* Slide Indicators */}
                                </div>
                                ))}
                                ...
                                <div className='mt-6 sm:col-span-8 lg:col-span-7'>
                                    ...
                                    <div aria-labelledby='information-heading' className='mt-1'>
                                        ...
                                        <p className='mt-3 font-medium text-gray-900'>{product.description}</p>
                                        <p className='mt-3 font-medium text-gray-900'>${product.price.toFixed(2)}</p>
                                    </div>
